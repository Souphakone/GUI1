...
(function (factory) {
  ...
  EvoCalendar.prototype.limitTitle = function (title, limit) {
    var newTitle = [];
    limit = limit === undefined ? 35 : limit;
  ...
  EvoCalendar.prototype.addEventList = function (event_data) {
    ...
    markup += "</p>";
    if (event_data.class)
      markup += '<p class="event-class">' + event_data.class + "</p>";
    if (event_data.teacher)
      markup += '<p class="event-teacher">' + event_data.teacher + "</p>";
    if (event_data.start && event_data.end)
      markup +=
        '<p class="event-schedule"><span>' +
        event_data.start +
        "</span><span> - </span><span>" +
        event_data.end +
        "</span> </p>";
